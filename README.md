...
│
├── pyproject.toml     <- Project configuration file with package metadata for qbanalysis
...
│
└── qbanalysis                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes qbanalysis a Python module
    │
